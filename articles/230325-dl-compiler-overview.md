...
**「大域的な」コンパイラ最適化**: 従来の汎用コンパイラにおいて命令レベルで実行していた最適化の中には、深層学習モデルの演算ノードレベルで適用できる最適化があります。例えば以下の最適化が含まれます。
...
**ループ最適化**: ループ融合、sliding window、タイル化、ループの並び替え、およびループ展開などがあります。
:::details ループ最適化の詳細
